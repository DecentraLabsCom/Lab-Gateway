...
local function resolve_lab_manager_admin_access_path()
    ...
    local candidates = {
        dir .. "/../../lua/lab_manager_admin_access.lua",
        dir .. "/../lua/lab_manager_admin_access.lua",
        "openresty/lua/lab_manager_admin_access.lua",
        "lua/lab_manager_admin_access.lua"
    }
    ...
    error("Cannot locate lab_manager_admin_access.lua for tests")
end
...
local function run_guard(opts)
    ...
    with_env(env, function()
        dofile(resolve_lab_manager_admin_access_path())
    end)
    _G.ngx = nil
...
runner.describe("Lab manager strict admin guard", function()
    runner.it("returns 503 when LAB_MANAGER_TOKEN is not configured", function()
        local ngx = run_guard({
