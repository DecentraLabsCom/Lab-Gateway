...
test('loads the activity controller before the Lab Manager bootstrap', () => {
  ...
  assert.match(
    html,
      /lab-manager-tabs\.js\?v=workflow-tabs-v1[\s\S]*lab-manager-activity\.js\?v=lab-manager-activity-v1[\s\S]*lab-manager-access-policy\.js\?v=lab-manager-access-policy-v1[\s\S]*lab-manager-heartbeat-errors\.js\?v=lab-manager-heartbeat-errors-v1[\s\S]*lab-manager-hosts\.js\?v=lab-manager-hosts-v1[\s\S]*lab-manager-host-discovery\.js\?v=lab-manager-host-discovery-v1[\s\S]*lab-manager-winrm-credentials\.js\?v=lab-manager-winrm-credentials-v1[\s\S]*lab-manager-winrm-trust\.js\?v=lab-manager-winrm-trust-v1[\s\S]*lab-manager-host-provisioning\.js\?v=lab-manager-host-provisioning-v1[\s\S]*lab-manager-host-actions\.js\?v=lab-manager-host-actions-v1[\s\S]*lab-manager-host-feature\.js\?v=lab-manager-host-feature-v1[\s\S]*core\/toast\.js\?v=lab-manager-toast-v1[\s\S]*lab-manager-notifications-access\.js\?v=lab-manager-notifications-access-v1[\s\S]*core\/pagination\.js\?v=lab-manager-pagination-v1[\s\S]*core\/formatters\.js\?v=lab-manager-formatters-v1[\s\S]*lab-manager-reservation-values\.js\?v=lab-manager-reservation-values-v1[\s\S]*lab-manager-reservation-renderers\.js\?v=lab-manager-reservation-renderers-v1[\s\S]*lab-manager-notifications-config\.js\?v=lab-manager-notifications-config-v1[\s\S]*lab-manager-notifications\.js\?v=lab-manager-notifications-v1[\s\S]*lab-manager-notifications-feature\.js\?v=lab-manager-notifications-feature-v1[\s\S]*lab-manager-fmu-sync\.js\?v=lab-manager-fmu-sync-v1[\s\S]*lab-manager-aas-link\.js\?v=lab-manager-aas-link-v1[\s\S]*lab-manager-digital-twins\.js\?v=lab-manager-digital-twins-v1[\s\S]*lab-manager-power-credentials\.js\?v=lab-manager-power-credentials-v1[\s\S]*lab-manager-power-renderers\.js\?v=lab-manager-power-renderers-v4[\s\S]*lab-manager-power-values\.js\?v=lab-manager-power-values-v4[\s\S]*lab-manager-power-operations\.js\?v=lab-manager-power-operations-v1[\s\S]*lab-manager-power-status\.js\?v=lab-manager-power-status-v2[\s\S]*lab-manager-power-controllers\.js\?v=lab-manager-power-controllers-v3[\s\S]*lab-manager-power-policies\.js\?v=lab-manager-power-policies-v4[\s\S]*lab-manager-energy-feature\.js\?v=lab-manager-energy-feature-v1[\s\S]*lab-manager-reservations-feature\.js\?v=lab-manager-reservations-feature-v1[\s\S]*lab-manager\.js\?v=workflow-tabs-v18/,
  );
});
