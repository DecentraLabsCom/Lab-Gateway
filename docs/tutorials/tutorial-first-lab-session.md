...
Lab publishing is done entirely from the **Marketplace**. You need to be logged in with
your institutional SSO credentials and have the provider role confirmed (Part 1 complete).
