...
* **Network:**
  ...
  * _Port:_ This should be set to "3389" for RDP connections to work.
* **Authentication**
  * _Username:_ Windows accounts' username. This is the Windows account you want to allow your lab users to use when accessing your computer.
...
* **Remote App**
  ...
  * _Parameters:_ These are inline parameters passed to dLabAppControl.exe. There are two important ones: the lab app's window class and the lab app's path in your system. To learn how to obtain the window class of your lab app, read the documentation in Lab App.
